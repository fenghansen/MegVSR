...
class BaseParser():
    ...
    def parse(self):
        ...
        self.parser.add_argument("--model_name", "-n", default='VRRDB_Unet', type=str, help="model_name")
        ...
        self.parser.add_argument("--crop_per_image", "-crop", default=6, type=int, help="crop_per_image")
        self.parser.add_argument("--learning_rate", "-lr", default=2e-5, type=float, help="learning_rate")
