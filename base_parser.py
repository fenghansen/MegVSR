...
class BaseParser():
    ...
    def parse(self):
        ...
        self.parser.add_argument("--model_name", "-n", default='VRRDB_6', type=str, help="model_name")
        ...
        self.parser.add_argument("--learning_rate", "-lr", default=6.4e-5, type=float, help="learning_rate")
